...
function buildSidebar(activeItem, role, user, basePath) {
  ...
  const footerBlock = `
    <div class="sidebar-footer">
      <a href="${basePath}settings.html" class="sidebar-user" style="text-decoration:none;color:inherit;">
  ...
  const studentNav = `
    ...
    <nav class="sidebar-nav">
      ...
      <a href="${basePath}dashboard.html" class="nav-item ${activeItem==='dashboard'?'active':''}">
      ...
      <a href="${basePath}exam-mode.html" class="nav-item ${activeItem==='exam'?'active':''}">
      ...
      <a href="${basePath}topics.html" class="nav-item ${activeItem==='topics'?'active':''}">
      ...
      <a href="${basePath}assignments.html" class="nav-item ${activeItem==='assignments'?'active':''}">
      ...
      <a href="${basePath}spot-the-flaw.html" class="nav-item ${activeItem==='spotflaw'?'active':''}">
      ...
      <a href="${basePath}land.html" class="nav-item ${activeItem==='essay'?'active':''}">
      ...
      <a href="${basePath}link.html" class="nav-item ${activeItem==='link'?'active':''}">
      ...
      <a href="${basePath}settings.html" class="nav-item ${activeItem==='settings'?'active':''}">
  ...
  const teacherNav = `
    ...
    <nav class="sidebar-nav">
      ...
      <a href="${basePath}builder.html" class="nav-item ${activeItem==='builder'?'active':''}">
      ...
      <a href="${basePath}students.html" class="nav-item ${activeItem==='students'?'active':''}">
